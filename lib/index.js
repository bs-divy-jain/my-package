 ...
 */
exports.getTwodigitFormat = (data) => {
...
exports.formatTimestamp = (timestamp) => {
    ...
    let date = exports.getTwodigitFormat(Time.getDate());
    let month = exports.getTwodigitFormat(Time.getMonth() + 1);
    let year = Time.getFullYear();
    // Extract time components
    let hours = exports.getTwodigitFormat(Time.getHours());
    let minutes = exports.getTwodigitFormat(Time.getMinutes());
 ...
 */
exports.tweleveHourFormat = (hours) => {
    hours = hours % 12;
